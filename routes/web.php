...
Route::group(['prefix' => 'admin'], function () {
     ...
     Route::get('/category/create', 'CategoryController@create_category')->name('admin.create.category');
     Route::post('/category/create', 'CategoryController@store_category')->name('admin.category.store');

     Route::get('/category/edit/{id}', 'CategoryController@edit_category')->name('admin.categories.edit');
